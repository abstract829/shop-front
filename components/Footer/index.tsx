  ...
  return (
    <footer className="text-center text-lg-start bg-light text-muted">
        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-6 mx-auto mb-md-0 mb-4 text-center">
              ...
              <div>
                <p className="m-1">
                  <i className="fas fa-home me-3"></i> {Config.address}
                </p>
                <p className="m-1">
                  <i className="fas fa-envelope me-3"></i>
                  {Config.mail}
                </p>
                {Config.phone.map((number, key) => (
                  <p key={key} className="m-1">
                    <i className="fas fa-phone me-3"></i> {number}
                  </p>
                ))}
              </div>
            </div>
      ...
      <div className="text-center p-4 bg-light border-top">
        ...
        <a className="text-reset fw-bold" href={Config.linkCopyright}>
          {Config.nameCopyright}
        </a>
      </div>
    </footer>
  );
